      ...
      @if ($items->count()>0)
        <div class="cart-table__wrapper">
              ...
              <tr>
                ...
                <td>
                  <div class="qty-control position-relative">
                    <input type="number" name="quantity" min="1" value="{{$item->qty}}" class="qty-control__number text-center">
                ...
                @csrf
                @method('DELETE')
                  <button type="submit" href="javascript:void(0)" class="remove-cart" style="background: none; border: none; padding: 0;">
          ...
          @endif
            ...
            <form action="post" action="{{route('cart.empty')}}">
            @csrf
            @method('DELETE')
                 ...
                 <table class="cart-totals">
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>${{Session::get('discounts'['code'])}}</td>
                      </tr>
                      <tr>
        ...
        @else
            <div class="row">
                <div class="col-md-12 text-center pt-5 tb-5">
