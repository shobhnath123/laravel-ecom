...
@section('content')
  <main class="pt-90">
    ...
    <section class="shop-checkout container">
      ...
      <form method="POST" name="checkout-form" action="{{route('cart.place.order')}}"  class="form">
        @csrf
        @method('POST')
            ...
            <div class="row" >
              ...
              <div class="my-account_address-list">
                <div class="my-account_address-list-item">
                  <div class="my-account_address-item_details">
                    <p>{{$address->name}}</p>
                    <p>{{$address->address}}</p>
              ...
              <div class="checkout__totals">
                ...
                <table class="checkout-cart-items">
                  ...
                  @foreach (Cart::instance('cart') as $item)
                    <tr>
                      <td>
                       {{$item->name}}
                        <span class="checkout-cart-item__quantity">× {{$item->qty}}</span>
                      </td>
                      <td align="right">
                        ${{$item->subtotal();}}
                      </td>
                ...
                <table class="checkout-totals">
                  <tbody>
                    ...
                    <tr>
                      <th>Discount</th>
                      <td class="text-right">- ${{Session::get('discounts')}}</td>
                    </tr>
                    <tr>
