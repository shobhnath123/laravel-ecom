...
@section('content')
      ...
      <div class="shop-list flex-grow-1">
        ...
        <div class="d-flex justify-content-between mb-4 pb-md-2">
          ...
          <div class="shop-acs d-flex align-items-center justify-content-between justify-content-md-end flex-grow-1">
              ...
              <select class="form-select w-auto border-0 py-0 order-1 order-md-0" aria-label="Page Size" id="pagesize" name="pagesize" style="margin-right:20px;">
                <option disabled {{ $size == 12 || $size == 24 || $size == 48 || $size == 102 ? '' : 'selected' }}>Show</option>
 ...
 <input type="hidden" id="hdnBrands" name="brands" value="{{ $brands }}">
  </form>
...
$(function(){
  $("#pagesize").on("change", function(){
    $("#size").val($("#pagesize option:selected")).val(); // ensure #size exists in your HTML
    $("#frmfilter").submit();
  });
  $("#orderby").on("change", function(){
    $("#order").val($("#borderby option:selected")).val(); // ensure #order exists in your HTML
    $("#frmfilter").submit();
  });
